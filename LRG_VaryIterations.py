...
#Test different values for number of iterations and see how performance improves
params = [1, 5, 10, 20, 50, 100, 500, 1000]
metrics = [evaluate(train_data, test_data, param, 0.000001, 0.0, 'l2', False) for param in params]
print params
print metrics
